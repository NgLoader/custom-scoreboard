...
import de.ngloader.scoreboard.api.ScoreboardObjective;
import de.ngloader.scoreboard.api.ScoreboardSidebar;
...
public class SharedScoreboard implements Scoreboard {
	...
	public Scoreboard addToPlayers(Player player, Player... players) {
		...
		for (Player morePlayer : players) {
			this.players.add(morePlayer);
		}
	...
	public Scoreboard removeFromPlayers(Player player, Player... players) {
		...
		for (Player morePlayer : players) {
			this.players.remove(morePlayer);
		}
